    ...
    Do
        ...
        Else
            ...
            Select Case strTestData
                   ...
                   Case "form", "designer", "usercontrol"
...
BottomOfLoop:
    ...
    With mtypSTATS
        If mblnIncludeBlankLines Then
            ...
            strMsg1 = strMsg1 & " (Counted)"
        Else
            strMsg1 = strMsg1 & " (Not Counted)"
        End If
        
        If mblnIncludeComments Then
            .TotalLines = .TotalLines + .CommentLines
            strMsg2 = strMsg2 & " (Counted)"
        Else
            strMsg2 = strMsg2 & " (Not Counted)"
        End If
...
BottomOfLoop:
    ...
    With mtypSTATS
        ...
        If mblnIncludeAutoGen Then
            ...
            strMsg0 = strMsg0 & " (Counted)"
        Else
            strMsg0 = strMsg0 & " (Not Counted)"
        End If
...
Private Sub CreateReport()
    ...
    strText = objKeyEdit.CenterReportText(RPT_LINE_LENGTH, , strLeftSide, strRightSide)
    ...
    strText = objKeyEdit.CenterReportText(RPT_LINE_LENGTH, strFilename)
    Print #hFile, strText
    
    ' Optional title line designating who
    ' requested or where report is destined
    If Len(gstrOptTitle) > 0 Then
        strText = objKeyEdit.CenterReportText(RPT_LINE_LENGTH, gstrOptTitle)
        Print #hFile, strText
    End If
